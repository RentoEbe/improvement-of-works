...
class GetToday:
    today = datetime.now() # This is object. print(today) result is 2026-06-16 00:13:41.525251

    @staticmethod
    def get_today_date_int():
        """
        get today's date:
        :return: today's date which type is integer ex)20261023
        """
        today_date = int(str(date.today()).replace('-',''))
        return today_date
    ...
    def get_today_date_str(cls):
        """
        get today's day:
        :return: ex) if today is 6/15, result is "2026/6/15/Thursday"
        """
